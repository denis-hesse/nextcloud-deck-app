...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .history-panel { position:fixed; top:0; left:560px; width:336px; max-height:25vh; background:var(--surface); border-left:2px solid var(--blue); display:flex; flex-direction:column; overflow:hidden; box-sizing:border-box; z-index:100; min-width:200px; max-width:600px; }
