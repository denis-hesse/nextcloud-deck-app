...
<div class="wrap">
  <div id="new-mail-banner" style="display:none; background:#0082C9; color:white; padding:10px 14px; border-radius:var(--rs); margin-bottom:1rem; display:none; align-items:center; justify-content:space-between; gap:10px;">
